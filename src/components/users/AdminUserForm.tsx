        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div>
            ...
            <Select
              ...
              disabled={isSubmitting}
            >
              <option value={AdminRole.EDITOR}>Editor (Full Access)</option>
              <option value={AdminRole.READONLY}>Read Only</option>
            </Select>
            {errors.role && (
              <p className="mt-1 text-sm text-red-600">{errors.role.message}</p>
            )}
            <p className="mt-1 text-xs text-gray-500">
              Editor can create and modify all resources. Read Only can only
              view resources.
            </p>
          </div>
        </div>
